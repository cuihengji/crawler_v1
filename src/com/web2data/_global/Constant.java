...
public class Constant {
	...
	public static final int MAX_NUMBER_OF_JUNIOR_SESSION = 10;
	
	// 启动浏览器 Session的 时间间隔
	public static final int SENIOR_SESSION_STARTUP_INTERVAL_SCECONDS = 15;
	
	// 启动 HttpClient Session的 时间间隔
	public static final int JUNIOR_SESSION_STARTUP_INTERVAL = 5;
