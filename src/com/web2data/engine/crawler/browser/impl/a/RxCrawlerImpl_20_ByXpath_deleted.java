...
public class RxCrawlerImpl_20_ByXpath_deleted {

//	
//    // -------------------------------------------------------
//    private static final transient Logger logger = Logger.getLogger(RxCrawlerImpl_20_ByXpath_deleted.class);
//	
//
...
//				return null;
//			} else {
//				return new RxNodeImpl(webDriver, element, xpath, null);
//			}
//		} catch (Throwable t) {
...
//				for (WebElement webElement : webElementList) {
//
//					RxNode rxNode = new RxNodeImpl(webDriver, webElement, xpath, newTabWindow);
//					elements.add(rxNode);
//				}
//				return elements;
//			}
...
//
//						for (WebElement webElement : elementList) {
//							elements.add(new RxNodeImpl(webDriver, webElement, xpath, newTabWindow));
//						}
//						break;
//					} else {
//						List<WebElement> subIframes = webDriver.findElements(By.tagName("iframe"));
